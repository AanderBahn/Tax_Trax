...
Trip.create!([
  ...
  {job_id: 1, shift_hours: 2, starting_odometer: 2.0, ending_odometer: 3.0, vehicle_id: 1, created_at:},
  {job_id: 9, shift_hours: 4, starting_odometer: 4.0, ending_odometer: 5.0, vehicle_id: 1, created_at:},
  {job_id: 7, shift_hours: 47, starting_odometer: 47.0, ending_odometer: 48.0, vehicle_id: 1, created_at:}
])
